  ...
  return (
    <>
      <section className="hero">
        ...
        <div className="eyebrow">{t("ежедневный ритуал спокойствия", "your daily calm ritual")}</div>
        ...
        <p className="lead">{t("Одна минута тишины в день. Дыши, слушай живые звуки и замедляйся — без рекламы, регистрации и спешки.", "One minute of quiet a day. Breathe, hear living sound and slow down — no ads, no signup, no rush.")}</p>
        <div className="cta">
      ...
      <section className="section">
        ...
        <footer className="foot">
          ...
          <p className="foot-priv">{t("Здесь нет сервера для твоих данных. Всё, что ты создаёшь, живёт только в твоём браузере — код открыт, можно проверить.", "There is no server for your data. Everything you create lives only in your browser — the code is open, you can verify it.")}</p>
          <div className="foot-links">
            <a href="https://github.com/wasdtherapy/wasdwebsite" target="_blank" rel="noopener noreferrer">{t("Открытый код", "Open source")} ↗</a>
            <a href="https://github.com/wasdtherapy/wasdwebsite" target="_blank" rel="noopener noreferrer">{t("★ Поддержать звездой", "★ Support with a star")}</a>
          </div>
