...
const TOOLS = [
  ...
  { href: "/sounds", icon: "🌊", ru: "Звуки", en: "Sounds", rd: "Генеративный микшер на 9 слоёв природы.", ed: "A generative mixer of 9 nature layers." },
  ...
  { href: "/meditate", icon: "🧘", ru: "Медитация", en: "Meditate", rd: "Гайдовые сессии 3 / 5 / 10 минут.", ed: "Guided 3 / 5 / 10 minute sessions." },
      ...
      <section className="section">
        <Reveal>
          <div className="section-head">
            ...
            <h2>{t("Шесть способов выдохнуть", "Six ways to exhale")}</h2>
