...
const TOOLS = [
  { href: "/breathe", icon: "🫁", ru: "Дыхание", en: "Breathe", rd: "6 научных техник + своя методика и мини-гайды.", ed: "6 science techniques + your own method and mini-guides." },
  { href: "/scenarios", icon: "🧩", ru: "Сценарии", en: "Scenarios", rd: "Готовые связки дыхание+звук+таймер в один тап.", ed: "Ready breath+sound+timer flows in one tap." },
  ...
  { href: "/mood", icon: "🌤", ru: "Настроение", en: "Mood", rd: "Отмечай состояние и смотри мягкий график динамики.", ed: "Track how you feel and see a gentle trend chart." },
  { href: "/garden", icon: "🌱", ru: "Сад", en: "Garden", rd: "Твой сад растёт за каждую минуту тишины.", ed: "Your garden grows with every calm minute." },
  ...
  { href: "/asmr", icon: "🖐", ru: "АСМР", en: "ASMR", rd: "Тыкай по приятным звукам — мягкий отклик.", ed: "Tap pleasant sounds — soft response and shimmer." },
  { href: "/play", icon: "🎈", ru: "Игры", en: "Play", rd: "Лопай пузырьки под пентатонику. Чистый дзен.", ed: "Pop bubbles to a pentatonic scale. Pure zen." },
