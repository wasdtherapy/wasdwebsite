...
const TOOLS = [
  ...
  { href: "/mood", icon: "🌤", ru: "Настроение", en: "Mood", rd: "Отмечай состояние и следи за мягкими стриками.", ed: "Log how you feel and keep gentle streaks." },
  ...
  { href: "/asmr", icon: "🖐", ru: "АСМР", en: "ASMR", rd: "Тыкай по приятным звукам — мягкий отклик и переливы.", ed: "Tap pleasant sounds — soft response and shimmer." },
