...
export async function startPad() {
  ...
  const CHORDSETS: Record<string, string[][]> = {
    dawn: [["D3", "F3", "A3", "C4"], ["G2", "B2", "D3", "F3"], ["A2", "C3", "E3", "G3"], ["F2", "A2", "C3", "E3"]],
    day: [["C3", "E3", "G3", "B3"], ["A2", "C3", "E3", "G3"], ["F2", "A2", "C3", "E3"], ["G2", "B2", "D3", "F3"]],
    dusk: [["A2", "C3", "E3", "G3"], ["F2", "A2", "C3", "E3"], ["D2", "F2", "A2", "C3"], ["E2", "G2", "B2", "D3"]],
    night: [["A2", "C3", "E3"], ["F2", "A2", "C3"], ["D2", "F2", "A2"], ["E2", "G2", "B2"]],
  };
  const slot = hour < 7 ? "night" : hour < 11 ? "dawn" : hour < 18 ? "day" : hour < 22 ? "dusk" : "night";
  const chords = CHORDSETS[slot];
  try { Tone.Transport.bpm.rampTo(slot === "night" ? 40 : slot === "day" ? 52 : 46, 6); } catch {}
  let i = 0;
