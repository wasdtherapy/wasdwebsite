...
export function sectionMeta(key: string): Metadata {
  ...
  return {
    ...
    openGraph: { title: fullTitle, description: s.desc, url, type: "website", images: [{ url: "/og.png", width: 1200, height: 630 }] },
    twitter: { card: "summary_large_image", title: fullTitle, description: s.desc, images: ["/og.png"] },
  };
}
