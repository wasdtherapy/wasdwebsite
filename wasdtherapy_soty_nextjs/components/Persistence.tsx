...
export default function Persistence() {
  useEffect(() => {
    ...
    const unsub = useStore.subscribe((s) => {
      const data = { lang: s.lang, palette: s.palette, autoTheme: s.autoTheme, volume: s.volume, muted: s.muted, mindfulSeconds: s.mindfulSeconds, mixer: s.mixer, favorites: s.favorites };
