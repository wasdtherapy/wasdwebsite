...
const LINKS = [
  ...
  { href: "/guide", ru: "Гид", en: "Guide" },
  { href: "/sense", ru: "Сенсор", en: "Sense" },
  ...
  return (
    <header className="nav">
      ...
      <div className="nav-right">
        <button className="lang-btn menu-btn" onClick={() => setMenuOpen(true)} aria-label={lang === "ru" ? "Меню и поиск" : "Menu & search"} title={lang === "ru" ? "Меню и поиск" : "Menu & search"}>☰</button>
        <SettingsButton />
        <PaletteSwitcher />
