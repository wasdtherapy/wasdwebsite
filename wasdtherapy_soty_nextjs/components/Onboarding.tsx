...
export default function Onboarding() {
  ...
  const slides = [
    ...
    { icon: "⌘", ru: "Быстрый доступ", en: "Quick access", rd: "Нажми ⌘K (или Ctrl+K), чтобы мгновенно прыгнуть в любую практику.", ed: "Press ⌘K (or Ctrl+K) to jump into any practice instantly." },
  ];
  if (!open) return null;
