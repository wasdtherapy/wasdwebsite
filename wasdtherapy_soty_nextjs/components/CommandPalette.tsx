...
export default function CommandPalette() {
  ...
  const cmds: Cmd[] = useMemo(() => [
    ...
    { ru: "★ Поддержать проект", en: "★ Support the project", icon: "★", run: () => window.open("https://github.com/wasdtherapy/wasdwebsite", "_blank") },
    { ru: "Открытый код", en: "Open source", icon: "⌥", run: () => window.open("https://github.com/wasdtherapy/wasdwebsite", "_blank") },
